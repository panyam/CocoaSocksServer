...
@interface SocksServer : NSObject IMPLEMENTED_PROTOCOLS
{
 ...
 * 
 * If you wish to publish the service as a traditional server, you should set the type to be "_socks._tcp.".
 * 
